...
class UserRegisterForm(UserCreationForm):
  ...
  rol = forms.ChoiceField(choices=CustomUser.ROLES, widget=forms.Select(attrs={'class': 'w-full -ml-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500'}))

  class Meta:
    model = CustomUser
    fields = ['username', 'nombre', 'apellido', 'codigoUDG', 'rol', 'email', 'password1', 'password2']
